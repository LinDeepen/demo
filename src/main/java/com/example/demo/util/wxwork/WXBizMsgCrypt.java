...
import static com.example.demo.util.wxwork.AesException.IllegalAesKey;
...
public class WXBizMsgCrypt {
    ...
    public WXBizMsgCrypt(String token, String encodingAesKey, String receiveid) throws AesException {
        if (encodingAesKey.length() != 43) {
            throw new AesException(IllegalAesKey);
        }
...
//        System.out.println("postData的密文：" + encrypt[1].toString());
        // 验证安全签名
